"""Offline assertions for the WP25 placeholder pages, Exercises 7-12.
...
test_exercise_06_notebook.py), so none of the three is covered here any
more. This file confirms each remaining placeholder (7-12) exists, carries
