...
class LaunchButtonsAndPlaceholders(unittest.TestCase):
    ...
    # -- 28. Exercises 11-12 remain placeholders without launch buttons ------
    # (WP28 converted Exercise 5 into a notebook too, WP29 did the same for
    # Exercise 6, WP32 did the same for Exercise 7, WP33 did the same for
    # Exercise 8, WP34 did the same for Exercise 9, and WP38 did the same for
    # Exercise 10; see test_exercise_05_notebook.py, test_exercise_06_notebook.py,
    # test_exercise_07_notebook.py, test_exercise_08_notebook.py,
    # test_exercise_09_notebook.py, and test_exercise_10_notebook.py for their
    # own launch-link assertions.)

    def test_exercises_11_through_12_remain_placeholders_without_launch_buttons(self):
