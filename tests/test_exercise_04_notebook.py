...
and that both interactive activities are embedded correctly.
...
class Notebook(unittest.TestCase):
    ...
    def test_run_or_download_block_matches_the_pattern_and_links_this_chapter(self):
        ...
        for other in ("chapter_01", "chapter_02", "chapter_03"):
    ...
    def test_only_the_360_approved_roi_features_are_predictors(self):
        ...
        # same FEATURES derivation line as Exercise 2/3's Section 2 recipe cell
    ...
    def test_only_one_brief_reminder_about_held_out_metrics(self):
        ...
        # may name "resubstitution" once, forward-referencing Exercise 2-3's
