...
// Proof that the embedded knn-explore activity (transferred from the old
// Exercise 3 by WP25) works on the *final built Exercise 2 HTML page*, served
// beneath the simulated GitHub Pages project subpath -- not just the
